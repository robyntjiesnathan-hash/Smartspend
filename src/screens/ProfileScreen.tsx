...
const s = StyleSheet.create({
  ...
  tabBar: { flexDirection: 'row', borderBottomWidth: 2, borderBottomColor: 'rgba(0,0,0,0.08)' },
  tabBtn: { flex: 1, paddingTop: 13, paddingBottom: 0, alignItems: 'center' },
  tabTxt: { fontSize: 13, fontWeight: '800', color: '#6B8F6B', marginBottom: 10 },
  tabTxtActive: { color: P.greenDark },
  tabLine: { height: 3, width: '100%', backgroundColor: 'transparent' },
