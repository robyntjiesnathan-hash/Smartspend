...
const s = StyleSheet.create({
  ...
  skipTxt: { color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: '800' },
  stepCount: { color: 'rgba(255,255,255,0.5)', fontSize: 12, fontWeight: '700' },
  illustPanel: {
  ...
  title: {
    ...
    letterSpacing: -0.7, lineHeight: 30,
  },
  body: {
  ...
  dotOn: { backgroundColor: P.lime, width: 22 },
  dotOff: { backgroundColor: 'rgba(255,255,255,0.28)', width: 7 },
  nextBtn: {
    backgroundColor: P.lime,
    borderRadius: 16,
    paddingVertical: 14,
  ...
  nextTxt: { color: P.greenDeep, fontSize: 15, fontWeight: '900' },
});
